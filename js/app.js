...
let sumArray = sum(sum(sumArr[0],sumArr[1])[0],sumArr[2]);
let array = [];
array.push(sumArray[0]);
array.push(sumArr + ' was passed in as an array of numbers, and ' + sumArray[0] + ' is their sum.');
return array;
}
...
function multiplyArray(multArr) { //eslint-disable-line
    let multiplyArray = multiply(multiply(multArr[0],multArr[1])[0],multArr[2]);
    let array = [];
    array.push(multiplyArray[0]);
    array.push('The numbers ' + multArr + ' have a product of ' + array[0] + '.');
    return array;
}
